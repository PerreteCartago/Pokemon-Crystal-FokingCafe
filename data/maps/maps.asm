...
MapGroup_Dungeons:
	...
	map CeruleanCave1F, TILESET_DARK_CAVE, CAVE, CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave2F, TILESET_DARK_CAVE, CAVE, CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCaveB1F, TILESET_DARK_CAVE, CAVE, CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslands, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB2F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB3F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB4F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
...
MapGroup_Cinnabar:
	...
	map CinnabarMart, TILESET_MART, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
