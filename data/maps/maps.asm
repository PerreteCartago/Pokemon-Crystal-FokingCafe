...
MapGroup_Cinnabar:
	...
	map PokemonMansion1F, TILESET_FACILITY, CAVE, LANDMARK_CINNABAR_ISLAND, MUSIC_VICTORY_ROAD, TRUE, PALETTE_DAY, FISHGROUP_LAKE
	map PokemonMansion2F, TILESET_FACILITY, CAVE, LANDMARK_CINNABAR_ISLAND, MUSIC_VICTORY_ROAD, TRUE, PALETTE_DAY, FISHGROUP_LAKE
